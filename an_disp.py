...
def energy(state):
    ...
    #y2=np.power(np.multiply(np.multiply(D[0],state[0])+np.multiply(D[1],state[1])+np.multiply(D[2],state[2])+np.multiply(D[3],state[3])+np.multiply(D[4],state[4]),1e2),1)
    ...
    #y2=np.power(np.multiply(np.multiply(D[0],state[0]),1e2),1)
    eq=y1-y2
    #eq = np.power(np.multiply(Di,li),1)-np.power(np.multiply(D[0],state[0]),1)-np.power(np.multiply(D[1],state[1]),1)-np.power(np.multiply(D[2],state[2]),1)-np.power(np.multiply(D[3],state[3]),1)-np.power(np.multiply(D[4],state[4]),1)
